...
<form:form action="/edit/${shows.id}"  method="post" modelAttribute="shows">
	<div class="form-group">
				<form:label path="title">Title</form:label>
				<form:errors path="title" class="error text-danger"/>
				<form:input path="title" type="text" class="form-control"/>		
		
				<form:label path="network">Author</form:label>
				...
				<form:textarea path="description"  rows="8" class="form-control"/>		
